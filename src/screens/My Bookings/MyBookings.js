...
const Upcoming = ({
  ...
  const setBookingData = async () => {
    try {
      ...
      fetch(
        `https://trucktaxi.co.in/api/customer/getmybookings?customerid=${customerid}&type=Upcoming`,
        requestOptions,
      )
...
const Completed = ({
  ...
  const setBookingData = async () => {
    try {
      ...
      fetch(
        `https://trucktaxi.co.in/api/customer/getmybookings?customerid=${customerid}&type=Completed`,
        requestOptions,
      )
        .then(response => response.json())
        .then(result => {
