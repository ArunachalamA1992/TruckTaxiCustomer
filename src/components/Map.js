      ...
      <View style={[styles.container, { paddingBottom: keyboardHeight }]}>
        ...
        <View style={styles.inputContainer}>
          ...
          <View style={styles.DDView}>
            ...
            <Text style={styles.DDText}>Duration: {Math.ceil(duration)} mts</Text>
          </View>
          ...
          <TouchableOpacity
            style={styles.next}
            onPress={() => navigation.navigate('BookaPickup', { pickup: { position: origin, Description: pickupDescription }, drop: { position: Destination, Description: dropDescription } })}>
