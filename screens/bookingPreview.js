                ...
                fetch("https://trucktaxi.co.in/api/customer/getprofiledetails?mobileno=" + mobile, requestOptions)
                    ...
                    .then(result => {
                        ...
                        var raw = JSON.stringify({
                            ...
                            "fromloc": pickadd.description,
                            "fromloclat": (pickadd.location.lat).toString(),
                            "fromloclong": (pickadd.location.lng).toString(),
                            "toloc": pickdrop.description,
                            "toloclat": (pickdrop.location.lat).toString(),
                            "toloclong": (pickdrop.location.lng).toString(),
                            "tripdate": date,
                            "triptime": time,
                        ...
                        fetch("https://trucktaxi.co.in/api/customer/booknow", requestOptions)
                            .then(response => response.json())
                            .then(result => {
                                console.log("Confirm booking resp ============= :", JSON.stringify(result));
                ...
                <View style={[styles.footer]}>
                    ...
                    <View style={{ flex: 1, flexDirection: 'row', justifyContent: "space-between", alignItems: 'center', marginTop: 20 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            />
                            <Text style={{ fontSize: 16, color: Color.lightBlack, fontFamily: Manrope.SemiBold, paddingStart: 10 }}>Pickup :</Text>
                        </View>
                        <Text style={{ width: '70%', textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Manrope.Bold }} numberOfLines={2}>{pickadd.description}</Text>
                    </View>
                    <View style={{ flex: 1, flexDirection: 'row', justifyContent: "space-between", marginTop: 20 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Iconviewcomponent
                                ...
                                icon_color={Color.primary}
                            />
                            <Text style={{ fontSize: 16, color: Color.lightBlack, fontFamily: Manrope.SemiBold, paddingStart: 10 }}>Drop :</Text>
                        </View>
                        <Text style={{ width: '70%', textAlign: 'left', fontSize: 16, color: Color.black, fontFamily: Manrope.Bold }} numberOfLines={2}>{pickdrop.description}</Text>
                    </View>
                    ...
                    <Modal
                        ...
                        <Pressable
                            ...
                            <View
                                ...
                                <Text style={{ width: '100%', fontSize: 16, color: Color.black, fontFamily: Manrope.Bold }}>Enter Your Booking OTP</Text>
                                <OTPInput
                                    code={code.toString()}
                                    setCode={setCode}
