                ...
                AsyncStorage.getItem('userToken').then(value => {
                    ...
                    fetch("https://trucktaxi.co.in/api/customer/getprofiledetails?mobileno=" + mobile, requestOptions)
                        ...
                        .then(result => {
                            ...
                            fetch("https://trucktaxi.co.in/api/customer/getmybookings?customerid=" + id + "&type=Upcoming", requestOptions)
                                .then(response => response.json())
                                .then(result => {
                                    setData(result.data);
                                    setLoading(false);
                ...
                AsyncStorage.getItem('userToken').then(value => {
                    ...
                    fetch("https://trucktaxi.co.in/api/customer/getprofiledetails?mobileno=" + mobile, requestOptions)
                        ...
                        .then(result => {
                            ...
                            fetch("https://trucktaxi.co.in/api/customer/getmybookings?customerid=" + id + "&type=Completed", requestOptions)
                                .then(response => response.json())
                                .then(result => {
                                    setData(result.data)
                                    setLoading(false);
                ...
                <View style={styles.modelBg}>
                    <View style={styles.modal}>
                        ...
                        <View style={styles.modalView}>
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate('cancel', { id: "0", })}>
